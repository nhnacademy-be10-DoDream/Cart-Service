...
//		cartItemRepository.save(cartItem);
//
//		List<CartItem> beforeDelete = cartItemRepository.findByCart_CartId(1L);
//		assertThat(beforeDelete).isNotEmpty();
//
//		cartItemRepository.deleteByCart_CartId(1L);
//
//		List<CartItem> afterDelete = cartItemRepository.findByCart_CartId(1L);
