...
//		// given
//		CartItemRequest request = new CartItemRequest(1L, null, 5L);
//		CartItemResponse response = new CartItemResponse(cartItemId, bookId, "Updated Book", 10000L, 5L, "url");
//		given(cartItemService.updateCartItemQuantity(request.getCartId(),cartItemId, 5L)).willReturn(response);
//
//		// when & then
